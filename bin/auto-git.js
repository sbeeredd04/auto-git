...
function displayStyledHelp() {
  logger.section('Auto-Git v3.10.0', 'AI-powered Git automation with intelligent commit decisions and enhanced interactive terminal session');
...
program
  ...
  .action(async (options) => {
    try {
      ...
      logger.section('Auto-Git Watcher v3.10.0', 'Simple file monitoring with auto-commit (Ctrl+C to exit)');
...
program
  ...
  .action(async () => {
    logger.section('Auto-Git Diagnostics v3.10.0', 'System health check');
