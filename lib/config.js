...
export function getConfig() {
  ...
  config = {
    apiKey: null,
    watch: true,
    // Interactive features (new in v2.0)
    interactiveOnError: true,
    enableSuggestions: true,
    hotkeys: {
      // Cross-platform compatible hotkeys
      pause: 'ctrl+shift+p',      // Ctrl+Shift+P (works on both Mac and Windows)
      resume: 'ctrl+shift+r',     // Ctrl+Shift+R (works on both Mac and Windows)
      enterRepl: 'ctrl+shift+1',  // Ctrl+Shift+1 (works on both Mac and Windows)
      // Alternative number-based hotkeys for better terminal compatibility
      pauseAlt: '1',              // Press '1' key to pause
      resumeAlt: '2',             // Press '2' key to resume
      enterReplAlt: '3'           // Press '3' key to enter REPL
    },
