...
function displayMenu() {
  ...
  if (selectedIndex > 0 || menuActive) {
    process.stdout.write('\x1b[' + (menuOptions.length + 4) + 'A'); // Move cursor up
...
function hideMenu() {
  ...
  process.stdout.write('\x1b[' + (menuOptions.length + 6) + 'A'); // Move cursor up
  process.stdout.write('\x1b[0J'); // Clear from cursor to end of screen
}
